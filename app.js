...
applyLanguage();load();
const FIRST_TASTING_NOTE_TRANSLATIONS={"ru":"Первая дегустация — новая система оценки. Данные перенесены из журнала дегустации от 04.09.2026. Дегустацию проводили Сергей и Вова; один общий результат.","en":"First tasting — new scoring system. Transcribed from the tasting journal dated 04.09.2026. Tasting conducted by Сергей и Вова; one joint result.","de":"Erste Verkostung — neues Bewertungssystem. Daten aus dem Verkostungsjournal vom 04.09.2026 übertragen. Verkostung durch Sergej und Wowa; ein gemeinsames Ergebnis.","fr":"Première dégustation — nouveau système d’évaluation. Données transcrites du journal de dégustation du 04.09.2026. Dégustation réalisée par Sergueï et Vova ; un seul résultat commun.","es":"Primera cata — nuevo sistema de evaluación. Datos transcritos del diario de cata del 04.09.2026. Cata realizada por Serguéi y Vova; un único resultado conjunto.","it":"Prima degustazione — nuovo sistema di valutazione. Dati trascritti dal diario di degustazione del 04.09.2026. Degustazione effettuata da Sergej e Vova; un unico risultato congiunto.","pt":"Primeira degustação — novo sistema de avaliação. Dados transcritos do diário de degustação de 04.09.2026. Degustação realizada por Sergej e Vova; um único resultado conjunto."};
for (const [lng,textValue] of Object.entries(FIRST_TASTING_NOTE_TRANSLATIONS)) { if (!DATA_TEXT[lng]) DATA_TEXT[lng]={}; DATA_TEXT[lng]["First tasting — new scoring system. Transcribed from the tasting journal dated 04.09.2026. Tasting conducted by Сергей и Вова; one joint result."]=textValue; }
